...
let g:template['c']['ife3'] = "if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            ...
            \"else {\<cr>".g:rs."...".
            \g:re."\<cr>}"
let g:template['c']['ife4'] = "if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else {\<cr>".g:rs."...".
            \g:re."\<cr>}"
let g:template['c']['ife5'] = "if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            ...
            \"else {\<cr>".g:rs."...".
            \g:re."\<cr>}"
let g:template['c']['ife6'] = "if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            ...
            \"else {\<cr>".g:rs."...".
            \g:re."\<cr>}"
let g:template['c']['ife7'] = "if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            ...
            \"else {\<cr>".g:rs."...".
            \g:re."\<cr>}"
let g:template['c']['ife8'] = "if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            ...
            \"else {\<cr>".g:rs."...".
            \g:re."\<cr>}"
let g:template['c']['ife9'] = "if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
...
let g:template['c']['sc']="scanf(\"".g:rs."...".g:re."\", ".g:rs."...".g:re.");"

"freopen函数和fclose函数
let g:template['c']['fre']="freopen(\"/".g:rs."...".g:re."\", \"".g:rs."...".g:re."\", ".g:rs."...".g:re.");"
let g:template['c']['fcl']="fclose(".g:rs."...".g:re.");"

"struct和typedef struct
let g:template['c']['str']="struct " .g:rs."...".g:re. "{\<cr>".g:rs."...".g:re."\<cr>};"
let g:template['c']['ts']="typedef struct " .g:rs."...".g:re. "{\<cr>".g:rs."...".g:re."\<cr>} ".g:rs."...".g:re.";"
